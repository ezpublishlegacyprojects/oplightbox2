...
{if $image_content.is_valid}
    ...
    {if and( is_set( $image ), $image )}
        ...
        {if and( $lightbox, $href|eq('') ) }<a title="{$title|wash(xhtml)}" href={$image_content.original.url|ezroot} rel="{ezini('OPLightBoxSettings', 'LightBoxAPI', 'oplightbox2.ini')}">{/if}
